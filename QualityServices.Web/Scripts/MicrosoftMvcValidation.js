...
Sys.Mvc.FormContext.OnSuccessEnableClientValidation = function (ajaxContext) {
    ...
    var updateTarget = document.getElementById(ajaxContext._updateTarget.id);
    ...
    while (mvcClientValidationMetadataOldScripts.length > 0) {
        ...
        mvcClientValidationMetadataOldScripts[0].parentNode.removeChild(mvcClientValidationMetadataOldScripts[0]);
    }
